...
namespace Veritas.Government.AU.VIC;

/// <summary>Represents a validated Victoria driver licence number.</summary>
...
/// <summary>Provides validation and generation for Victoria driver licence numbers.</summary>
public static class DriverLicenceNumber
{
    /// <summary>Attempts to validate the supplied Victoria driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random Victoria driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random Victoria driver licence number using the supplied options.</summary>
