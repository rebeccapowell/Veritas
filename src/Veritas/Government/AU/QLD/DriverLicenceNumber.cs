...
namespace Veritas.Government.AU.QLD;

/// <summary>Represents a validated Queensland driver licence number.</summary>
...
/// <summary>Provides validation and generation for Queensland driver licence numbers.</summary>
public static class DriverLicenceNumber
{
    /// <summary>Attempts to validate the supplied Queensland driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random Queensland driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random Queensland driver licence number using the supplied options.</summary>
