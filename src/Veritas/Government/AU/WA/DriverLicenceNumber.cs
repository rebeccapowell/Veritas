...
namespace Veritas.Government.AU.WA;

/// <summary>Represents a validated Western Australia driver licence number.</summary>
...
/// <summary>Provides validation and generation for Western Australia driver licence numbers.</summary>
public static class DriverLicenceNumber
{
    /// <summary>Attempts to validate the supplied Western Australia driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random Western Australia driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random Western Australia driver licence number using the supplied options.</summary>
