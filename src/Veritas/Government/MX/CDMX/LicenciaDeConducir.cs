...
namespace Veritas.Government.MX.CDMX;

/// <summary>Represents a validated Ciudad de México driver licence number.</summary>
...
/// <summary>Provides validation and generation for Ciudad de México driver licence numbers.</summary>
public static class LicenciaDeConducir
{
    /// <summary>Attempts to validate the supplied Ciudad de México driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random Ciudad de México driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random Ciudad de México driver licence number using the supplied options.</summary>
