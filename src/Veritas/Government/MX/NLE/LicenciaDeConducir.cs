...
namespace Veritas.Government.MX.NLE;

/// <summary>Represents a validated Nuevo León driver licence number.</summary>
...
/// <summary>Provides validation and generation for Nuevo León driver licence numbers.</summary>
public static class LicenciaDeConducir
{
    /// <summary>Attempts to validate the supplied Nuevo León driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random Nuevo León driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random Nuevo León driver licence number using the supplied options.</summary>
