...
namespace Veritas.Government.MX.JAL;

/// <summary>Represents a validated Jalisco driver licence number.</summary>
...
/// <summary>Provides validation and generation for Jalisco driver licence numbers.</summary>
public static class LicenciaDeConducir
{
    /// <summary>Attempts to validate the supplied Jalisco driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random Jalisco driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random Jalisco driver licence number using the supplied options.</summary>
