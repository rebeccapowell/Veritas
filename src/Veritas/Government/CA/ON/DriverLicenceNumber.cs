...
namespace Veritas.Government.CA.ON;

/// <summary>Represents a validated Ontario driver licence number.</summary>
...
/// <summary>Provides validation and generation for Ontario driver licence numbers.</summary>
public static class DriverLicenceNumber
{
    /// <summary>Attempts to validate the supplied Ontario driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random Ontario driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random Ontario driver licence number using the supplied options.</summary>
