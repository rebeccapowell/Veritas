...
namespace Veritas.Government.CA.BC;

/// <summary>Represents a validated British Columbia driver licence number.</summary>
...
/// <summary>Provides validation and generation for British Columbia driver licence numbers.</summary>
public static class DriverLicenceNumber
{
    /// <summary>Attempts to validate the supplied British Columbia driver licence number.</summary>
    ...
    /// <summary>Attempts to generate a random British Columbia driver licence number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random British Columbia driver licence number using the supplied options.</summary>
