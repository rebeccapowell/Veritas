...
namespace Veritas.Government.US.NY;

/// <summary>Represents a validated New York driver license number.</summary>
...
/// <summary>Provides validation and generation for New York driver license numbers.</summary>
public static class DriverLicenseNumber
{
    /// <summary>Attempts to validate the supplied New York driver license number.</summary>
    ...
    /// <summary>Attempts to generate a random New York driver license number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random New York driver license number using the supplied options.</summary>
