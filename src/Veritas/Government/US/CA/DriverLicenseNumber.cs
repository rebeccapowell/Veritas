...
namespace Veritas.Government.US.CA;

/// <summary>Represents a validated California driver license number.</summary>
...
/// <summary>Provides validation and generation for California driver license numbers.</summary>
public static class DriverLicenseNumber
{
    /// <summary>Attempts to validate the supplied California driver license number.</summary>
    ...
    /// <summary>Attempts to generate a random California driver license number into the provided buffer.</summary>
    ...
    /// <summary>Attempts to generate a random California driver license number using the supplied options.</summary>
