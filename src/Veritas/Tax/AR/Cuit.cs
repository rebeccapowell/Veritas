...
namespace Veritas.Tax.AR;

public readonly struct CuitValue
{
    public string Value { get; }
    public CuitValue(string value) => Value = value;
}

/// <summary>
/// Argentina CUIT/CUIL tax identifier (11 digits, mod-11 checksum).
/// </summary>
public static class Cuit
{
    private static readonly int[] Weights = new[] { 5, 4, 3, 2, 7, 6, 5, 4, 3, 2 };

    public static bool TryValidate(ReadOnlySpan<char> input, out ValidationResult<CuitValue> result)
    {
