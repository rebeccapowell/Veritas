...
namespace Veritas.Tax.LT;

public readonly struct AsmensKodasValue
{
    public string Value { get; }
    public AsmensKodasValue(string value) => Value = value;
}

/// <summary>
/// Lithuania Asmens kodas (11 digits, two-stage mod-11).
/// </summary>
