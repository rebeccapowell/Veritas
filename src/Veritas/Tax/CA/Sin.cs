...
public readonly struct SinValue
{
    public string Value { get; }
    public SinValue(string value) => Value = value;
}

public static class Sin
{
    public static bool TryValidate(ReadOnlySpan<char> input, out ValidationResult<SinValue> result)
    {
